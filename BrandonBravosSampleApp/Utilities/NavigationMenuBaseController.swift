...
class NavigationMenuBaseController: UITabBarController {
    ...
    static let initialViewController = HomeViewController()
...
enum CustomTabItem: String, CaseIterable {
    ...
    var viewController: UIViewController {
        switch self {
        case .home:
            let initialViewController = NavigationMenuBaseController.initialViewController;
    ...
    private func getIconImageString(forIcon tabItem: CustomTabItem, isSelected: Bool)-> String{
        let selectedString = isSelected ? "_selected" : ""
        let iconString = "\(tabItem.rawValue)_icon\(selectedString)"
        return iconString
    }
